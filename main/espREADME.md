...
#----------------------------------------------
For data logger, there are 4 analog inputs (scale 0 - 3.3V) and 4 digital inputs (scale: 0 - 3.3V) used for reading.
The connection of 4 analog inputs is:

GPIO36 - ADC1 Channel 0 - SP
GPIO39 - ADC1 Channel 3 - SN
GPIO34 - ADC1 Channel 6
GPIO35 - ADC1 Channel 7

The connection of 4 digital inputs is:
GPIO23 - DI1
GPIO22 - DI2
GPIO19 - DI3
GPIO18 - DI4
